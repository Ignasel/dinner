...
public class AdapterDinner extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        myHolder.textPayment.setText("Abilities: " + current.getPayment());
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MyHolder(View itemView) {
            super(itemView);
            textName = (TextView) itemView.findViewById(R.id.textDinnerType);
        ...
        public void onClick(View v) {
            ...
            Toast.makeText(context, dinner.getDinnerType()+ " " + dinner.getPrice(),
